...
const KNOBS: Knob[] = [
  ...
  {
    id: 'heldfill',
    label: 'Body \u00b7 held disc, own light',
    what: 'how much of its own identity a HELD body\u2019s disc is washed with. Spec 04 \u00a71 fixes every disc at #100C20 and the author overruled it for a grab: \u201cit makes the planet feel like a hole going to something below/deeper than the anomaly\u201d. **The hole is literal** \u2014 the anomaly\u2019s cloud bed stacks to about \u03b1 0.40, which over the true-black gaps is (102, 38, 65) against the disc\u2019s (16, 12, 32), so the thing drawn BEHIND the body is up to 6\u00d7 brighter than it. 0.30 is where the disc reaches the bed\u2019s own brightness. 0 is the spec',
    min: 0,
    max: 0.8,
    step: 0.02,
    base: view.HELD_FILL,
    apply: view.set_HELD_FILL,
    restarts: false,
    group: 'bodies',
    places: 2,
  },
