...
|---|-----------|-----------|------|--------|
| [M0](./m0-foundations.md) | Foundations, specs, renderer verdict | Specs written, a field you can pan, a renderer ADR | — | **M0.1–M0.2 done** ([specs](../spec/), scaffold) — the Pages deploy is written but unverified while the repo has no remote; M0.3–M0.5 not started |
