...
|---|-----------|-----------|------|--------|
| [M0](./m0-foundations.md) | Foundations, specs, renderer verdict | Specs written, a field you can pan, a renderer ADR | — | **M0.1–M0.2 done** ([specs](../spec/), scaffold) — CI and the Pages deploy are written but have never run; the repo has no remote yet and pushing it is deferred; M0.3–M0.5 not started |
