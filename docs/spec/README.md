...
| [00 · Tokens](./00-tokens.md) §7 | **Whether the design space's height is a contract or a reference.** Built as a contract — 1170 × 2532 fitted whole and letterboxed (ADR-0010) — and measured in [M1.6](../plan/m1-the-swing.md): on ADR-0011's 393 × 651 phone viewport the browser's own chrome binds the fit, so the game draws at **77%** of the size the prototype draws it at on the same phone, and shows 844 world units of height where the prototype shows 646. (The 46-point strip either side is no longer a bar: M1.4 fills it with bleed, which buys width and changes nothing about the size question.) §7's own wording — *"the thumb line sits at 2/3 of the **screen** height"* — leaves room for the other reading, in which the design *width* is the contract and the visible height flexes. **Measured, 2026-08-28**, over 877 releases that reached another body: at the moment of release, the body the craft next grabs is inside the picture **88%** of the time as built, **68%** under the width reading in a phone browser, and **45 – 89%** across devices under it — the flexing height makes *how much you can see* a property of the hardware. Nothing in the scoring reads the viewport, so this is information rather than points. The two readings **agree at 89%** on a phone's *whole screen*, which says the pressure is the browser's chrome rather than the design space |
