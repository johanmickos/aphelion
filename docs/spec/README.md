...
| [00 · Tokens](./00-tokens.md) §7 | **Whether the design space's height is a contract or a reference.** Built as a contract — 1170 × 2532 fitted whole and letterboxed (ADR-0010) — and measured in [M1.6](../plan/m1-the-swing.md): on ADR-0011's 393 × 651 phone viewport the browser's own chrome binds the fit, so the game draws at **77%** of the size the prototype draws it at on the same phone, with a 46-point bar down each side, and shows 844 world units of height where the prototype shows 646. §7's own wording — *"the thumb line sits at 2/3 of the **screen** height"* — leaves room for the other reading, in which the design *width* is the contract and the visible height flexes. Not urgent, and the M1 gate is the first thing it touches |
